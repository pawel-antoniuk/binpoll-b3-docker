...
config_data="{\"apiUrl\":\"$BINPOLL_API_URL\", \
                \"pollSoundsUrl\":\"$BINPOLL_API_URL/static/poll_sounds/\", \
                \"exampleVideoAssetUrl\": \"/assets/example-movie/\", \
                \"siteKey\": \"6LdIsbkUAAAAAPBkzsJMlTwsPczyhtnPA27EJ_Rr\"\
                }"
